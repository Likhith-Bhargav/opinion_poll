    ...
    <div className="poll-detail">
      ...
      <div className="poll-content">
        <div className="poll-info">
          <h2 className="poll-title">{currentPoll.title}</h2>
          ...
          <div className="poll-meta">
            <div className="meta-item">
              ...
              <span className="meta-value">{currentPoll.creator_username}</span>
            </div>
            <div className="meta-item">
              <span className="meta-label">Date</span>
              <span className="meta-value">
                {new Date(currentPoll.created_at).toLocaleDateString('en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}
            ...
            <div className="meta-item">
              ...
              <span className="meta-value">{getTotalVotes()}</span>
            </div>
          </div>
        </div>
            ...
            <div className="chart-section">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={getChartData()}>
                  ...
                  />
                  <Bar dataKey="votes" fill="url(#goldGradient)" radius={[4, 4, 0, 0]} />
                  <defs>
                    <linearGradient id="goldGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="#f4e192" />
